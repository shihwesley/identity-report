 ...
 */
export async function deriveKeysFromMnemonic(mnemonic) {
 ...
 */
export function createDidFromPublicKey(publicKey) {
 ...
 */
export async function createWalletIdentity(mnemonic) {
 ...
 */
export async function deriveEncryptionKey(privateKey, password) {
 ...
 */
export async function signAccessGrant(grant, privateKey) {
